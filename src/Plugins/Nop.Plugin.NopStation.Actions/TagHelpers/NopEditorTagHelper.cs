...
namespace Nop.Plugin.NopStation.Core.TagHelpers
{
    /// <summary>
    /// "nop-editor" tag helper
    /// </summary>
    [HtmlTargetElement("nop-editor-check", Attributes = FOR_ATTRIBUTE_NAME, TagStructure = TagStructure.WithoutEndTag)]
    public class NopEditorTagHelper : TagHelper
    {
        ...
        public override async Task ProcessAsync(TagHelperContext context, TagHelperOutput output)
        {
            ...
            if (For.Metadata.ModelType.Name.Equals("String") && !await _permissionService.AuthorizeAsync(CorePermissionProvider.ManageNopStationFeatures))
                htmlOutput = new Microsoft.AspNetCore.Html.HtmlString($"<input class=\"form-control text-box single-line valid\" data-val=\"true\" id=\"{For.Name}\" id=\"{For.Name}\" type=\"text\" value=\"***********\" aria-describedby=\"{For.Name}-error\" aria-invalid=\"false\">");
